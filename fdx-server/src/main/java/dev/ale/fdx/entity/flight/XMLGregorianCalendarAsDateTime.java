...
import org.jvnet.hyperjaxb3.xml.bind.annotation.adapters.AbstractXMLGregorianCalendarAdapter;
...
public class XMLGregorianCalendarAsDateTime extends AbstractXMLGregorianCalendarAdapter {
	...
	public Date createDate(XMLGregorianCalendar calendar) {
		...
		final java.sql.Timestamp timestamp = new java.sql.Timestamp(calendar.normalize().toGregorianCalendar().getTimeInMillis());
		return timestamp;
	}
