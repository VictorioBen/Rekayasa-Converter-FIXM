 ...
 *          
 * 
 * <p>Java class for FlightLevelType complex type.
 * 
 ...
 *       &lt;attribute name="uom" use="required" type="{http://www.fixm.aero/base/4.1}UomFlightLevelType" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@Entity(name = "FlightLevelType")
@Table(name = "FLIGHTLEVELTYPE")
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FlightLevelType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FlightLevelType that = ((FlightLevelType) object);
        {
            double lhsValue;
        ...
        {
            UomFlightLevelType lhsUom;
            lhsUom = this.getUom();
            UomFlightLevelType rhsUom;
            rhsUom = that.getUom();
