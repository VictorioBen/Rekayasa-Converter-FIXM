 ...
 *       &lt;attribute name="status" type="{http://www.fixm.aero/messaging/4.1}FilingStatusValueType" />
...
@Entity(name = "FilingStatusType")
@Table(name = "FILINGSTATUSTYPE")
    ...
    implements Equals, HashCode
{
    ...
    protected FilingStatusValueType status;
    ...
    public FilingStatusValueType getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(FilingStatusValueType value) {
        this.status = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FilingStatusType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final FilingStatusType that = ((FilingStatusType) object);
        {
            FilingStatusValueType lhsStatus;
            lhsStatus = this.getStatus();
            FilingStatusValueType rhsStatus;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            FilingStatusValueType theStatus;
