 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.fixm.aero/base/4.1>RestrictedGroundSpeedType">
 *       &lt;attribute name="uom" use="required" type="{http://www.fixm.aero/base/4.1}UomGroundSpeedType" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@Entity(name = "GroundSpeedType")
@Table(name = "GROUNDSPEEDTYPE")
    ...
    implements Equals, HashCode
{
    ...
    protected UomGroundSpeedType uom;
     ...
     * @return
     *     possible object is
     *     {@link UomGroundSpeedType }
     *     
     */
    @Basic
    @Column(name = "UOM", length = 255)
    @Enumerated(EnumType.STRING)
    public UomGroundSpeedType getUom() {
        return uom;
    }
     ...
     *     
     */
    public void setUom(UomGroundSpeedType value) {
        this.uom = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GroundSpeedType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GroundSpeedType that = ((GroundSpeedType) object);
        {
            double lhsValue;
        ...
        {
            UomGroundSpeedType lhsUom;
            lhsUom = this.getUom();
            UomGroundSpeedType rhsUom;
            rhsUom = that.getUom();
