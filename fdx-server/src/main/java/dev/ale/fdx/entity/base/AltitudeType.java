 ...
 *       &lt;attribute name="uom" use="required" type="{http://www.fixm.aero/base/4.1}UomAltitudeType" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@Entity(name = "AltitudeType")
@Table(name = "ALTITUDETYPE")
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AltitudeType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AltitudeType that = ((AltitudeType) object);
        {
            double lhsValue;
        ...
        {
            UomAltitudeType lhsUom;
            lhsUom = this.getUom();
            UomAltitudeType rhsUom;
            rhsUom = that.getUom();
