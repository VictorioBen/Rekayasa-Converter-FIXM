 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.fixm.aero/base/4.1>RestrictedWeightType">
 *       &lt;attribute name="uom" use="required" type="{http://www.fixm.aero/base/4.1}UomWeightType" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WeightType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WeightType that = ((WeightType) object);
        {
            double lhsValue;
        ...
        {
            UomWeightType lhsUom;
            lhsUom = this.getUom();
            UomWeightType rhsUom;
            rhsUom = that.getUom();
