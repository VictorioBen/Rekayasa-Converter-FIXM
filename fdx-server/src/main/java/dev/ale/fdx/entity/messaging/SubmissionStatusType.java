 ...
 * 
 * 
 * <p>Java class for SubmissionStatusType complex type.
 * 
 ...
 *       &lt;attribute name="status" type="{http://www.fixm.aero/messaging/4.1}SubmissionStatusValueType" />
...
@XmlType(name = "SubmissionStatusType")
@Entity(name = "SubmissionStatusType")
@Table(name = "SUBMISSIONSTATUSTYPE")
    ...
    implements Equals, HashCode
{
    ...
    protected SubmissionStatusValueType status;
    ...
    public SubmissionStatusValueType getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(SubmissionStatusValueType value) {
        this.status = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SubmissionStatusType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SubmissionStatusType that = ((SubmissionStatusType) object);
        {
            SubmissionStatusValueType lhsStatus;
            lhsStatus = this.getStatus();
            SubmissionStatusValueType rhsStatus;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            SubmissionStatusValueType theStatus;
