 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.fixm.aero/base/4.1>RestrictedLengthType">
 *       &lt;attribute name="uom" use="required" type="{http://www.fixm.aero/base/4.1}UomLengthType" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final LengthType that = ((LengthType) object);
        {
            double lhsValue;
        ...
        {
            UomLengthType lhsUom;
            lhsUom = this.getUom();
            UomLengthType rhsUom;
            rhsUom = that.getUom();
